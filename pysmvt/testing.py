...
def mockmail(func):
    '''
        ...
        functional or unit testing by mocking pysmvt.mail.EmailMessage and
...
Called pysmvt.mail.EmailMessage.send()""".strip()
    ...
    def newfunc(*arg, **kw):
        try:
            ...
            minimock.mock('pysmvt.mail.EmailMessage', tracker=tt)
            pysmvt.mail.EmailMessage.mock_returns = minimock.Mock('pysmvt.mail.EmailMessage', tracker=tt)
            minimock.mock('pysmvt.mail.MarkdownMessage', tracker=tt)
            pysmvt.mail.MarkdownMessage.mock_returns = minimock.Mock('pysmvt.mail.MarkdownMessage', tracker=tt)
            minimock.mock('pysmvt.mail.HtmlMessage', tracker=tt)
            pysmvt.mail.HtmlMessage.mock_returns = minimock.Mock('pysmvt.mail.HtmlMessage', tracker=tt)
            kw['mm_tracker'] = tt
            func(*arg, **kw)
        finally:
            minimock.restore()
